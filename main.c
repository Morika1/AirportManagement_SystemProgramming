...
int main(int argc, char* argv[])
{
	...
	Company			company;
	char* managerFileName = NULL;
	char* companyFileName = NULL;
	if (argc >= 3)
	{
		managerFileName = argv[1];
		companyFileName = argv[2];
	}
	initManagerAndCompany(&manager, &company, managerFileName, companyFileName);
